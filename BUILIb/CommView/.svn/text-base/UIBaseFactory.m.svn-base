...
+(ZCSAlertInforView*)forkNetLoadingImageAnimationView
{
    ...
    {
        CGRect rect =  CGRectMake(kDeviceScreenWidth-(250.f/2.f),kMBAppRealViewHeight+2.f,250.f/2.f,84.f/2.f);
    ...
    {
        naimationView.frame =  CGRectMake(kDeviceScreenWidth-(250.f/2.f),kMBAppRealViewHeight+2.f+42.f,250.f/2.f,84.f/2.f);
    }
    NE_LOGRECT(naimationView.frame);
    return naimationView;
}
+(ZCSAlertInforView*)forkNetLoadingImageAnimationView:(UIView*)view
{
    if(naimationView == nil)
    {
        CGRect rect =  CGRectMake(kDeviceScreenWidth-(250.f/2.f),kMBAppRealViewHeight+2.f,250.f/2.f,84.f/2.f);
        ...
        naimationView = [[ZCSAlertInforView alloc]initWithFrame:rect withText:@"加载中..." withImages:imageArr];
        [view addSubview:naimationView];
    }
    /*
    naimationView.frame =  CGRectMake(kDeviceScreenWidth-(250.f/2.f),kMBAppRealViewHeight+2.f,250.f/2.f,84.f/2.f);
    */
    //NE_LOGRECT(naimationView.frame);
    return naimationView;
