...
#define  kLoginAndSignupHintTextColor               HexRGB(70,70,70)

#define  kLoginAndSignupHintTextFont               [UIFont systemFontOfSize:15]
...
#define  kLoginCellItemHeight                          45.f

#define  kRegisterCellImageItemHeight                  83.f
