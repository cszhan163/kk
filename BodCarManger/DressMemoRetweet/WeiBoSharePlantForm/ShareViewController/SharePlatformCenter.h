...
@protocol SharePlatformCenterDelegate;

@interface SharePlatformCenter : NSObject <WeiBoEngineDataDelegate, UIAlertViewDelegate>{
...
@property (nonatomic, assign) id<SharePlatformCenterDelegate> delegate;
...
@protocol SharePlatformCenterDelegate <NSObject>

- (void)centerSendStatusCompleted:(SharePlatformCenter *)center;
- (void)centerSendStatusFailed:(SharePlatformCenter *)center;
