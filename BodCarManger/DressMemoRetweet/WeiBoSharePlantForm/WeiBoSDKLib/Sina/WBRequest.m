...
- (id)parseJSONData:(NSData *)data error:(NSError **)error
{
	...
	id result = [NSJSONSerialization JSONObjectWithData:[dataString dataUsingEncoding:NSUTF8StringEncoding] options:NSJSONReadingAllowFragments error:&parseError];
	if (parseError)
    {
        if (error != nil)
        {
