...
//  iPlat4M
//
//  Created by wang yuqiu on 11-6-27.
...
typedef enum {
    ...
    EFProgressModeIndeterminate,
    /** Progress is shown using a MBRoundProgressView. */
	EFProgressModeDeterminate,
	/** Shows a custom view */
	EFProgressModeCustomView
} EFProgressMode;

typedef enum {
    /** Opacity animation */
    EFProgressAnimationFade,
    /** Opacity + scale animation */
    EFProgressAnimationZoom
} EFProgressAnimation;
...
@protocol EFProgressDelegate <NSObject>
 ...
 */
- (void)hudWasHidden:(EFProgress *)hud;
 ...
 */
@interface EFRoundProgressView : UIProgressView {}
 ...
 */
@interface EFProgress : UIView {
	
	EFProgressMode mode;
    EFProgressAnimation animationType;
	...
	id<EFProgressDelegate> delegate;
	NSString *labelText;
 ...
 */
+ (EFProgress *)showHUDAddedTo:(UIView *)view animated:(BOOL)animated;
 ...
 */
@property (assign) EFProgressMode mode;
 ...
 */
@property (assign) EFProgressAnimation animationType;
 ...
 */
@property (assign) id<EFProgressDelegate> delegate;
